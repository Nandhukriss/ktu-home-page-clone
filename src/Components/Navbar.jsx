        ...
        <nav className="navbar navbar-expand-md navbar-dark justify-content-center py-3 mb-4 " style={{backgroundColor:'#f7f7f7'}}>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item"><div  className="nav-link  text-light" aria-current="page" style={{backgroundColor:'#20bae5'}}>Home</div></li>
              <li className="nav-item"><div className="nav-link text-dark">Research</div></li>
              <li className="nav-item"><div className="nav-link text-dark">FAQ</div></li>
              <li className="nav-item"><div className="nav-link text-dark">Contact Us</div></li>
            </ul>
          </div>
        </nav>
      </div>
